...
public class C02StringManipulations {
    ...
    public static void main(String[] args) {
        ...
        String result1 = a%2!=0  ?   "Odd"  :    (a%3==0   ?     "Even and divisible by 3"   :   "Even but not divisible by3");

        System.out.println(result1);

        //Example 6: Type java code by using nested ternary.
        //Write a program to check if a year is leap year or not.
        //If the year is divisible by 100 then it must be divisible by 400. (2000 is leap year, 1800 not leap year)
