...
public class C06StringManipulations {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(t.lastIndexOf("v"));

        String d = "Learn java, earn money";

        System.out.println(d.replaceAll("Learn", "?"));

        String q ="Hello World!";

        System.out.println(q.length()>q.charAt(6));

        System.out.println(q.contains("E")!= q.equalsIgnoreCase("HELLO WORLD!"));
