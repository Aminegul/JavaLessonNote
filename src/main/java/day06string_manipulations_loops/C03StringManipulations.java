...
public class C03StringManipulations {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println(t.replaceAll("[at]","*"));

        System.out.println(t.replaceAll("[Z]","*"));
        ...
        String psd = "Canan Can";

        System.out.println(psd.startsWith("c"));
        System.out.println(psd.endsWith("n"));
        System.out.println(psd.startsWith("a",3));
        System.out.println(psd.startsWith("Can"));
