...
public class C05StringManipulations {
    ...
    public static void main(String[] args) {
        ...
        int numOfPuncts = s.replaceAll("[^\\p{Punct}]", "").length();   // ^==> different from  punctuation marks will be nothing <=== .lenght()
        ...
        int numOfWords = t.split(" ").length; // cut the string ===>  Learn/ Java,/ earn/ huge/ amount/ of/ money. === 6 ya böldü 7 tane kelime buldu.
