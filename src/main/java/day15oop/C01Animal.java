...
public class C01Animal {
    ...
    public static boolean isALive = true;  // static yapmazsam instance variable olur- ve her obje için değişebilir.
    // static olursa sadece bu class a özel olur. diğer classlarda bu classın adıyla çağırmamız gerekir.
