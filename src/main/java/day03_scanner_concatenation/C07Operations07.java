...
public class C07Operations07 {

    public static void main(String[] args) {

        // "=" ==> Assigment Operater ===> takes the value from the right then put it into the container on the left
        // "==" ==> Equality Operater ==> Checks if the value on the left is the same with the value on the right
        //         2+3==%  ==> true   2+4==3 ==>false  so "==" in Java returns "boolean"
