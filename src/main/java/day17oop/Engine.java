...
public interface Engine {
    ...
    void start ();
// All methods in an interface are "public" and "abstract" as default that is why no need to type "public" and "abstract" in method creation
    void stop ();
    ...
    default void price(){
     ...
     // STATİC VE DEFAULT ARASINDAKİ FARK NEDİR?
